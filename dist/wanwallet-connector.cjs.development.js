...
var abstractConnector = require('@web3-react-wan/abstract-connector');
var Web3ProviderEngine = _interopDefault(require('web3-provider-engine'));
var wanwallet = require('@wanswap/subproviders/lib/src/subproviders/wanwallet');
...
var WanWalletConnector = /*#__PURE__*/function (_AbstractConnector) {
  _inheritsLoose(WanWalletConnector, _AbstractConnector);
  function WanWalletConnector(_ref) {
    var _this;
  ...
  var _proto = WanWalletConnector.prototype;
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            if (!this.provider) {
              ...
              engine.addProvider(new wanwallet.WanWalletSubprovider());
  ...
  return WanWalletConnector;
}(abstractConnector.AbstractConnector);

exports.WanWalletConnector = WanWalletConnector;
//# sourceMappingURL=wanwallet-connector.cjs.development.js.map
